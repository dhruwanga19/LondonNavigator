...
class Params(BaseModel):
    fields: Optional[conlist(str, min_items=1, max_items=5)] = Field( # type: ignore
        default=None,
...
def get_places_by_name(path_params: PathParams, params: Optional[Params] = None):
    """Useful for finding info about a certain place. Input should be a specific location and not a general place like parks or roads."""
    ...
    response = {
            ...
            'viewport': place_details_data['result'].get('geometry', {}).get('location', {}),
